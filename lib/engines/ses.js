 ...
 *
 * <ul>
 *     <li><b>AWSAccessKeyID</b> - AWS access key (optional)</li>
 *     <li><b>AWSSecretKey</b> - AWS secret (optional)</li>
...
function SESTransport(options) {
    ...
    this.options.accessKeyId = options.AWSAccessKeyID;
    this.options.secretAccessKey = options.AWSSecretKey;
    this.options.sessionToken = options.AWSSecurityToken;
    this.options.apiVersion = '2010-12-01';
    this.options.region = result && result[3] || 'us-east-1';
